...
public:
    ...
    std::optional<const ::music::events::Snapshot*> getLatestSnapshot() const;
...
private:
    ...
    ::music::adapters::LockFreeEventQueue<std::unique_ptr<Event>, 1024> pendingEvents;
    ...
    std::vector<std::unique_ptr<::music::events::Snapshot>> snapshots;
    ...
    const ::music::events::Snapshot* findNearestSnapshot(size_t eventIndex) const;
